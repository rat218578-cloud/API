...
echo "═══════════════════════════════════════════════════════════════"
echo "🔧 CRIANDO ROTA /API/ROULETTE/LIVE"
echo "═══════════════════════════════════════════════════════════════"

# ========== ATUALIZA API_SERVER.PY ==========
...
echo "✅ api_server.py atualizado com rota /api/roulette/live!"

# ========== ADICIONA AO GIT ==========
git add api_server.py

# ========== COMMIT ==========
git commit -m "feat: adiciona rota /api/roulette/live para números reais

- Cria endpoint GET /api/roulette/live
- Cria endpoint POST /api/roulette/add para webhook
- Mantém histórico de números reais
- Fallback com números de exemplo"

# ========== PUSH ==========
git push origin main

echo "═══════════════════════════════════════════════════════════════"
echo "✅ ROTA CRIADA E ENVIADA!"
echo "═══════════════════════════════════════════════════════════════"
echo ""
echo "📋 AGORA O BACKEND TEM:"
echo "   ✅ GET /api/roulette/live - Busca números"
echo "   ✅ POST /api/roulette/add - Adiciona número"
echo "   ✅ Histórico de números reais"
echo ""
echo "🚀 Depois do deploy, os números vão aparecer!"
echo "   (Ainda são de exemplo, mas a rota existe!)"
echo "═══════════════════════════════════════════════════════════════"
