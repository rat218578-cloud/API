...
echo "═══════════════════════════════════════════════════════════════"
echo "🗑️ REMOVENDO SMART API DO BACKEND COMPLETAMENTE"
echo "═══════════════════════════════════════════════════════════════"

# ========== 1. REMOVE SMART_API_SERVICE.PY ==========
rm -f smart_api_service.py
echo "✅ smart_api_service.py removido!"
...
echo "✅ api_server.py restaurado (sem Smart API)!"

# ========== 3. COMMIT ==========
git add api_server.py
git rm -f smart_api_service.py 2>/dev/null || true
git commit -m "revert: remove Smart API completamente, volta para números simulados"
git push origin main

echo "═══════════════════════════════════════════════════════════════"
echo "✅ SMART API REMOVIDA COMPLETAMENTE!"
echo "═══════════════════════════════════════════════════════════════"
echo ""
echo "📋 O QUE VOLTOU:"
echo "   ✅ Números simulados (aleatórios)"
echo "   ✅ API REST funcionando"
echo "   ✅ Sem Smart API"
echo "   ✅ Sem erro 403"
echo ""
echo "🚀 DEPOIS DO DEPLOY, OS NÚMEROS VÃO APARECER (SIMULADOS)!"
echo "═══════════════════════════════════════════════════════════════"
