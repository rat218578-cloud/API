...
export function FootballStudioDashboard() {
  ...
  const getResultadoColor = (resultado: string) => {
    if (resultado === 'H') return 'bg-red-500/20 text-red-400';      // CASA = VERMELHO
    if (resultado === 'A') return 'bg-blue-500/20 text-blue-400';    // VISITANTE = AZUL
    if (resultado === 'D') return 'bg-yellow-500/20 text-yellow-400'; // EMPATE = AMARELO
