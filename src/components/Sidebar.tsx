...
return (
<aside
className={\`fixed left-0 top-0 h-screen bg-bg-secondary border-r border-border-default transition-all duration-300 z-50 flex flex-col \${ collapsed ? "w-16" : "w-64" }\`}
>
