...
echo "═══════════════════════════════════════════════════════════════"
echo "🔧 CORRIGINDO EXTRAÇÃO DO EVOSESSIONID (BASE64)"
echo "═══════════════════════════════════════════════════════════════"
...
echo "✅ websocket_service.py corrigido (suporte a base64)!"

# ========== COMMIT E PUSH ==========
git add websocket_service.py
git commit -m "fix: decodifica base64 para extrair EVOSESSIONID do parâmetro params"
...
echo "   ✅ Decodifica base64 do parâmetro 'params'"
echo "   ✅ Extrai EVOSESSIONID do texto decodificado"
echo "   ✅ Procura por tokens no formato 'tzt...'"
echo "   ✅ Conecta WebSocket automaticamente"
echo ""
echo "🚀 DEPOIS DO DEPLOY:"
echo "   1. Faça login"
echo "   2. Abra a roleta"
echo "   3. WebSocket vai conectar!"
echo "═══════════════════════════════════════════════════════════════"
